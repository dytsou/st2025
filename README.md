...
- **Lab0** - Introduction and Setup
  ...
  - See [Lab0/README.md](Lab0/README.md) for details

- **Lab1** - (See individual README)
  - See [Lab1/README.md](Lab1/README.md) for details

- **Lab2** - (See individual README)
  - See [Lab2/README.md](Lab2/README.md) for details

- **Lab3** - (See individual README)
  - See [Lab3/README.md](Lab3/README.md) for details

- **Lab4** - (See individual README)
  - See [Lab4/README.md](Lab4/README.md) for details

- **Lab5** - Security Testing
  - Buffer overflow vulnerabilities and ASAN
  - See [Lab5/README.md](Lab5/README.md) for details

- **Lab6** - Fuzzing Challenge
  - Fuzzing exercises
  - See [Lab6/README.md](Lab6/README.md) for details

- **Lab7** - LLVM Pass and AFL++ Fuzzing
  - Writing LLVM passes for command injection detection
  - See [Lab7/README.md](Lab7/README.md) for details
